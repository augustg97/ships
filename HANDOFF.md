...
## Round 179 — 2026-08-31 — the trireme's own navy kept the list, and the machine is not on it

**The r172 windlass residual's queue head (trireme, the LAST of the line) OPENED
AND CLOSED, judgment first (build/staging/r179/JUDGMENT.md) — and the judgment is
SILENCE, the third of the line to end that way, on a THIRD SHAPE the residual
asked to have named: not r176's inference stack over a later-era machine, not
r178's tradition with nothing to extend, but a COMPLETE INVENTORY THAT OMITS THE
MACHINE — the strongest silence of the three, because here the silence is not
absence of evidence: the Athenian navy's stone-cut dockyard inventories are
positive evidence of each warship's ENTIRE equipment (entele skeue), and no
winding machine is among it. It is r177's warrant inverted — the corbita DREW
because her ship's own gear list (Lucian's sentence) names the machine; the
trireme ends SILENT because her class's own gear lists, far fuller, omit it. The
same class of source, obeyed both ways.**

**The sources, verified this round: Torr 1894 (downloaded whole r177, grepped
again) — the whole book has ONE windlass sentence (p. 95) and it is the
sail-tackle of the big Roman merchantmen, r177's own evidence. His notes 161/166
quote the entire-gear lists verbatim (CIA II 807/808/809/811, 330/329 BC on):
every three- and four-banked ship carries 'ankyras sideras dyo' — two iron
anchors — and eight cables in two recorded sizes, four for the bow anchors, four
epigya to moor her stern to the beach; the hypozomata sit among the hanging
gear; and the inventory even WEIGHS the anchors — CIA II 807 col. b, twenty-odd
mnas, under half a hundredweight in Torr's reading of the damaged numeral, named
as his. LSJ s.v. stropheion (lsj.gr, fetched): the shipboard sense has exactly
ONE literary attestation — Lucian Nav. 5, the Isis, six centuries after this
hull's drawn year — and the word's classical-era epigraphic use is Delian
HARBOUR DUES ships paid for the USE of a windlass (IG XI(2).138 B 8, iv/iii BC):
the machine stood on the quay. Herodotus 7.36.3 (Perseus, Greek and English
fetched verbatim): in this hull's own drawn year (-480) the Hellespont bridge
cables — laid over pontoon triremes — were made taut EK GES, from the land, with
ONOISI XYLINOISI, wooden windlasses; LSJ s.v. onos gives the windlass sense to
Herodotus, a bone-setting frame and the Mechanics, never a ship. Aboard, the
machine had no work: anchors of under ~25 kg, some 200 hands, a 47 t hull moored
stern-to with her own listed shore-cables and hauled out on the ship-sheds'
slipways — she was the thing the shore's machines hauled. Named as NOT fetched:
Morrison, Coates & Rankov and the Olympias Final Report (both gated, both
already the card's cited hull sources), the IG II2 stones beyond Torr (PHI
script-gated; AIO HTTP 500 for IG II2 1604) — any of them attesting a shipboard
machine reopens the question. Stated in the provenance: the entire-gear lists
are the 4th-century navy's, ~150 years after the drawn year; the class's fullest
record at any date, the gap named.**

**JUDGED SILENT, stated in the data per rules 9/10: a "Windlass, judged" row
after "Steering, as drawn" (plain text, NO asterisks — the r178 Shipwright
raw-markdown class is still open and the row is written not to trip it) and
hull.windlassProvenance carrying the full judgment, sources and scope (the
classical trireme as her navy inventoried her; Hellenistic polyremes are
different ships and Moschion's forty is not read backward; the crew's direct
pull marked inference). No hull.windlass, no builder edit, no PARTS edit, no
audit edit owed: the r173 rule is generic over H.windlass (audit-hulls.js:3303,
re-checked), and the audit reads no provenance field (grepped, 0 matches).
Prose-only change; no sim or injection applies.**

**Frames, with timing stated: the opening 64-check ran 22:09:48–22:46:45 and PASSED
WHOLE — 64/64 ok, 0 movers, 0 BLANK, EXIT:0 — the FOURTH consecutive clean opening — no chromium tool ran beside it (all research remote fetches and
local reads until it exited, the r175 trap held), and ALL web/ edits landed
after the exit. Close solo on final code: ship-trireme 0.000% — the new row lands below that frame's panel fold, so no committed frame reaches the change and no acceptance is owed. Panel row
looked at (rule 1): one-off scrolled shot AFTER the ratchet and audits (build/staging/r179/z-trireme-card-windlass.png), row renders whole, FIRST shot clean — no raw asterisks in the row, written plain against the open r178 class; the card's cite line below it does show that class's raw asterisks, as it has in every committed frame — residual 2 unchanged, untouched per rule 7's frame budget. Rule 0, answered in writing: the frame reads as a rendered vessel on open water, not a chart. Three facts a viewer can read off it: her oars fan the full length of the hull from under the outrigger band, blades poised over the sea; a square mainsail is set amidships, brailed part-way up its yard, a smaller foresail forward; the hull is planked in lengthwise strakes, low freeboard amidships, the stern rising aft.**

**Audit: 33/0 twice on final code. Deployed: data-version 1788241806. Live verify below.**

**Named residuals, in order:** (1) NEW r179 — THE r172 WINDLASS LINE IS CLOSED:
eight hulls judged across seven rounds (cog r173 DRAW-wreck; junk+treasure r174
DRAW-texts; panokseon r175 DRAW-tradition; sekibune r176 SILENT-inference-stack;
corbita r177 DRAW-gear-list; dhow r178 SILENT-nothing-to-extend; trireme r179
SILENT-complete-inventory) — the line's three silence shapes and four draw
warrants are now the worked precedent set for every future gear judgment
(anchors next). (2) r178: the Shipwright rows print raw markdown —
shipwright.js:879 renders r[0]/r[1] unprocessed while app.js cRows runs inlineMD;
owed its OWN round with the frame budget, per rule 7. (3) r178: the dhow's
Belitung composite grapnel — DIRECT warrant, heads the anchors line when opened.
(4) r177: Lucian's second machine. (5) r173: the cog's Gangspill on the
aftcastle top. (6) r173: the cog's castles, fore and aft. (7) r173: the cog's
pale rudder slab. (8) r174: the junk's and treasure-ship's attested anchors, the
panokseon's drawn-plate anchor, the wasen yotsume-ikari — behind item 3's
grapnel. (9) r176: the sekibune's class-size question (kiwari read owed).
(10) The sweep-derived boxy classes: top (18), channel/cheek/cathead.
(11) Preussen mast livery (r155). (12) Endurance forecastle (RMG J9266).
(13) Azzam crest span. (14) r164 risen black unpierced. (15) r165 fantail
...
baseline has it. Close 64-check on final code: ran 00:21:28-00:58:11 and PASSED WHOLE — 64/64 ok, 0 movers, 0 BLANK, EXIT:0, worst frame globe-default at 0.046% (capture flap, under the 0.05% gate). All web/ edits
...
**Audit: 33/0 twice on final code, after the check exited. Deployed: data-version 1788249644. Live verify below.**
...
## Round 191 — 2026-09-01 — the yotsume takes its mass model: the member record had been on our own disk since r187

**The r190 queue head OPENED AND CLOSED (build/staging/r191/JUDGMENT.md): the
residual waited for a member record of the Japanese four-claw form to surface —
it had surfaced in March, unread. 表1 of the corpus paper we saved in r187
(松井広信「四爪鉄錨の基礎的研究」金沢大学考古学紀要 34, 2013, p.38, rendered at
300 DPI and transcribed) measures all 49 anchors at member level: the arms are
RECTANGULAR forged bars — 最大幅×最大厚 at the root, 最少幅×最少厚 at the fluke
tip — and the ring bars are calipered. r187 had taken only 全長 and one ring
from it.**

**The record read (27 consistently-printed anchors ≥190 cm; rows 41/42 excluded,
their printed 最少幅 exceeds their 最大幅): arm root 0.0346±0.0037 wide ×
0.0198±0.0033 thick (fractions of 全長, W:T ≈ 1.8), fluke tip 0.0220±0.0052 ×
0.0058±0.0031 — a wide thin blade. The r187 class drew round arms and a ring
bar 2–3× the record's. And the corpus's one weighed anchor gives the mass
calibration: the Kozushima wreck anchor, raised 1990, 全長 2.8 m, 330–340 kg by
forklift (約90貫) — 15.26 kg per m³ of 全長³.**

**Class change: the drawn members are the record's. Arms become square-bar
pieces (4-segment cylinders, faces axis-aligned, per-piece thickness scale —
thickness lies IN the sweep plane, the bar bends about its weak axis), tip a
flat blade cone; both rings take the type anchor the class already cites
(Onominato a: teardrop 44×19 of 3 cm bar, elongation 2.32 — the drawn 1.5 had
contradicted its own named source; accessory ring ⌀36 of 4×4.5 section). The
SHANK is the one member 表1 does not record: its square side is SOLVED so the
drawn iron weighs the record's kg at 7850 kg/m³ (the r190 pattern — recorded
members are not knobs; the unrecorded one takes the mass budget). Record field
kg 122, DERIVED by cube-law from the weighed find; at (2.0 m, 122 kg) the solve
returns side 9.4 cm at the crown tapering to 6.8 (0.0471·全長). NEW RULE
V-YMASS: iron integrated from the built scene — analytic volumes with 4-segment
cylinders and cones read as the square bars they are (area 2r², not πr²) —
through each world matrix's determinant, vs the record's kg, 12% band; when the
record carries no kg both builder and rule share the same named cube-law
default, so the rule is never vacuous.**

**CONTESTED, named in the provenance: the paper's own monument photographs read
shanks at 0.023–0.034 of 全長 (fig 15-1①, Fukuura #15 — masked-width read,
obliquity unbounded) against the solve's 0.047. Rust loss on century-exposed
survivors, the forklift's precision and working-vs-votive spread are the named
suspects. The weighed record outranks a garden photograph read.**

**Proofs on final code, each as predicted in the JUDGMENT before running:
inj-ya-mass (members ×0.8 x/z) → exactly ONE, V-YMASS 78/122; inj-ya-drag
(shank ×1.35) → V-YLEN 2.27/2.0 plus the PREDICTED honest V-YMASS second
152/122 (a stretched shank truly carries the extra iron — the r190 drag
precedent; the r187 drag file's own one-conviction comment predates mass
auditing and is superseded); inj-ya-tipsever (tips only, the r190 sever form)
→ V-YARMS alone, V-YMASS silent (tips are 0.63% of the iron). The clean
audit's integral returns the solved 122 exactly — solve and rule share the
same analytic volumes, and the loop closes. Audit 33/0 twice (post-land, and
on the final built tree).**

**Frames: opening 64 PAID AND PURE — launched 12:51 unedited, edits landed
13:24:51 atomically after frame 56 (action-myeongnyang) captured; 64/64, 0
movers, 0 BLANK, EXIT:0; frames 57–63 scored on the edited tree prove the
class edit inert elsewhere. Close solos: ship-sekibune 0.007% and
action-myeongnyang both WITHIN tolerance — the anchor's whole silhouette is
~90 px at the baseline's distance; no baseline moved, nothing accepted.**

**Looked at (rules 0/1, look-final-zoom.png, camera placed by PROJECTING the
anchor's own world box to screen — six blind framings missed before that):
the four-claw iron lies rolled on the foredeck planking, two claws to the
deck and two standing, the arms reading as flat forged bars now, not wire;
the teardrop head ring at the shank's top with the cable bent to it and the
coil flaked beside the so-yagura's face. Three facts a viewer can name: a
four-clawed anchor stowed at the bow, its cable coiled beside the deckhouse,
laid plank seams under both.**

**Deployed: data-version 1788295513. Card row and provenance carry the member
record, the weighing and the solve.**

**Named residuals, in order:** (1) NEW r191: a caliper record of the Kozushima
anchor's own members would settle the contested shank — fetch the 國學院大學
1993 site report (神津島沖海底遺跡) if it surfaces open. (2) r187: the 1433
Jingu Kogo engi emaki warship-anchor plate — fetch in resolution if it
surfaces open. (3) r187: the two ray-free anchor rest rules (grapnel,
stoneAnchor) still compare against the sheer FUNCTION, not the drawn plank —
move to the surface-asked form. (4) r186: the panokseon stone-station
inference (Taean reproduction photo). (5) r182 grapnel shank reconstruction.
(6) r183 junk stone bar class default. (7) r177 Lucian's second machine. (8)
r173 cog Gangspill. (9) r173 cog castles. (10) r173 cog rudder slab. (11)
r176 sekibune class-size (kiwari read). (12) boxy classes: top (18),
channel/cheek/cathead. (13) Preussen mast livery. (14) Endurance forecastle.
(15) Azzam crest span. (16) r164 risen black unpierced. (17) r165 fantail
