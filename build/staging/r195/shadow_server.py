#!/usr/bin/env python3
"""r195 pre-land shadow: serve web/ on :8151 with the two staged files
...
STAGE = os.path.expanduser('~/Ships/build/staging/r195')
MAP = {
    '/data/vessels.json': os.path.join(STAGE, 'vessels.json'),
