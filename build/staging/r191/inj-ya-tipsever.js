/* r191 tip-sever — the four fluke-tip cones stripped under an unchanged record
   ...
   four". V-YMASS must stay SILENT: the tips carry ~0.6% of the drawn iron,
   far inside the 12% band — the discrimination this proof exists to show. */
(() => {
