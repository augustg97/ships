#!/usr/bin/env python3
"""r187: open the sekibune card, scroll to the Ground tackle row, screenshot,
...
with sync_playwright() as pw:
    ...
    try:
        ...
        page.goto("http://localhost:8149/?frozen=1#v=ship&s=sekibune",
        ...
        page.screenshot(path="build/staging/r187/z-sek-card-anchor.png")
    finally:
        browser.close()
